...
public class Address {
    ...
    private List<Object> localizedMultiLineAddressDisplay = null;
    @JsonIgnore
    ...
    @JsonProperty("localized_multi_line_address_display")
    public List<Object> getLocalizedMultiLineAddressDisplay() {
        return localizedMultiLineAddressDisplay;
    }

    @JsonProperty("localized_multi_line_address_display")
    public void setLocalizedMultiLineAddressDisplay(List<Object> localizedMultiLineAddressDisplay) {
