    ...
    <table id="events">
        ...
        <c:forEach items="${events.events}" var="event">
            ...
            <tr>
               ...
               <td><a href="addingEvent?id=${event.id}&name=${event.name.text}&start=${event.start.local}&end=${event.end.local}&venueId=${event.venueId}"><img src="./images/GoogleCalendarLogo.png" width="50px"></a> 
		</td>
            </tr>
       </c:forEach> 
    </table>
