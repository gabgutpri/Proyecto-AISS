    ...
    <table id="event">
        ...
        <c:forEach items="${events.items}" var="event">  
            <tr>
                ...
                <td><a href="eventBriteEventInfo?venueId=${event.description}&eventId=${event.id}&date=${event.start.dateTime}"><img src="./images/info.jpg" width="50px"></a></td>
                <td><a href="deletingEvent?id=${event.id}"><img src="./images/delete.png" width="30px"></a></td>
            </tr>
       </c:forEach> 
    </table>
    <p>
