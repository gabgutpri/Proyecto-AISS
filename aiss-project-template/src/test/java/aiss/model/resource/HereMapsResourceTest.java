...
public class HereMapsResourceTest {
	...
	public void test() {
		...
		assertTrue("Incorrect result", map.getStaticMap("52.5159,13.3777").equals("https://image.maps.api.here.com/mia/1.6/mapview?c=52.5159,13.3777&z=15&app_id=uKSP1vd0obUMYG7Fesvl&app_code=EJq2FWk5Vjwts8keGjp01g"));
